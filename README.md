...
## como instalar
1. copia la carpeta theme_PixWakfu a la carpeta themes de wakfu
2. abre wakfu
3. ve a la configuracion
4. ve a la pestaña de temas
5. selecciona el tema PixWakfu

## OPCIONAL (ICONO DEL MOUSE)
1. ve a la carpeta theme_PixWakfu/theme/cursors
2. ve a la carpeta del juego wakfu/contents/gui_jar
3. abre gui.jar whit 7zip y ve a themes y pega la carpeta cursors
